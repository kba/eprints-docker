...
sub new
{
    ...
    ##Repository level phrase always overwrites the system level phrase (regardsless if the system ones are loaded before the repository ones). 
    ...
    my @lib_order = @{$repository->get_conf($flavour)};
    foreach (@lib_order)
    {
